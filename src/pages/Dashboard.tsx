...
export default function Dashboard() {
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-x-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col">
      ...
      <nav className="sticky top-[64px] sm:top-[73px] z-40 bg-black/40 sm:backdrop-blur-xl border-b border-slate-800/30 shadow-lg shadow-black/50">
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 overflow-y-auto max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-[calc(160px+env(safe-area-inset-bottom))] sm:pb-[250px] w-full">
