...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900">
          ...
          {saints.map((saint) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-medium text-white mb-1">{saint.name}</h3>
                <p className="text-xs sm:text-sm text-gray-400 mb-2 sm:mb-3">{saint.title}</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-12 sm:mb-16">
          <h3 className="text-3xl sm:text-4xl font-light text-white mb-3 sm:mb-4">How It Works</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl border border-gray-700/50 p-6 sm:p-8 text-center">
            ...
            <h4 className="text-lg sm:text-xl font-medium text-white mb-2 sm:mb-3">Answer Daily Questions</h4>
          ...
          <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl border border-gray-700/50 p-6 sm:p-8 text-center">
            ...
            <h4 className="text-lg sm:text-xl font-medium text-white mb-2 sm:mb-3">Train Your Saints</h4>
            <p className="text-sm sm:text-base text-gray-400">
          ...
          <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl border border-gray-700/50 p-6 sm:p-8 text-center">
            ...
            <h4 className="text-lg sm:text-xl font-medium text-white mb-2 sm:mb-3">Let Them Work</h4>
            <p className="text-sm sm:text-base text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-4 sm:gap-0">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-400 text-xs sm:text-sm">EverAfter AI</span>
            </div>
            <p className="text-gray-500 text-xs sm:text-sm text-center sm:text-right">Building digital legacies that last forever</p>
          </div>
        </div>
      </footer>
    </div>
