...
export default function TerraSetupWizard() {
  ...
  const failureRedirect = `${baseUrl}/devices`;
  ...
  const validateCredentials = async () => {
    ...
    try {
      ...
      try {
        response = await fetch(`${supabaseUrl}/functions/v1/terra-test`, {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-8">
