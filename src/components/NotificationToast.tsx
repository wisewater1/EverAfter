...
function Toast({ notification, onDismiss }: { notification: Notification; onDismiss: (id: string) => void }) {
    ...
    return (
        <div
            className={`${config.bgClass} sm:backdrop-blur-xl border rounded-xl shadow-lg p-4 pointer-events-auto transform transition-all duration-300 animate-slide-in-right flex items-start gap-3`}
            role="alert"
        >
