...
// Dev-only crash overlay with the raw stack. Production users get the
// branded ErrorBoundary instead of a monospace developer screen.
...
// rAF-throttled: the previous unthrottled handler forced layout reads on
// every pointer event across all .btn-reactive elements.
let pointerFrame = 0;
